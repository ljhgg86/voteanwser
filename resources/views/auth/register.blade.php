            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="realname" class="col-md-4 col-form-label text-md-right">{{ __('实名') }}</label>

                            <div class="col-md-6">
                                <input id="realname" type="text" class="form-control{{ $errors->has('realname') ? ' is-invalid' : '' }}" name="realname" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('电话') }}</label>
